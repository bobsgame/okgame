...
//	}
	...
	else
	{
		...
		else
		{
			...
			Caption* c = new Caption(nullptr, (int)(Caption::CENTERED_SCREEN), 0, -1, "This game requires a newer graphics card that supports FBO.", 12, BobColor::white, BobColor::black);
