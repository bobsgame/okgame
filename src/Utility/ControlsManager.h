...
public:
	...
	bool KEY_E_HELD = false;
	bool KEY_F_HELD = false;
	bool KEY_G_HELD = false;
	bool KEY_H_HELD = false;
	bool KEY_I_HELD = false;
	bool KEY_J_HELD = false;
	bool KEY_K_HELD = false;
	bool KEY_L_HELD = false;
	bool KEY_M_HELD = false;
	bool KEY_N_HELD = false;
	bool KEY_O_HELD = false;
	bool KEY_P_HELD = false;
	bool KEY_Q_HELD = false;
	bool KEY_R_HELD = false;
	bool KEY_S_HELD = false;
	bool KEY_T_HELD = false;
	bool KEY_U_HELD = false;
	bool KEY_V_HELD = false;
	bool KEY_W_HELD = false;
	bool KEY_X_HELD = false;
	bool KEY_Y_HELD = false;
	bool KEY_Z_HELD = false;
	bool KEY_COMMA_HELD = false;
	bool KEY_PERIOD_HELD = false;
	bool KEY_FRONTSLASH_HELD = false;
	bool KEY_SEMICOLON_HELD = false;
	bool KEY_QUOTE_HELD = false;
	bool KEY_BACKSLASH_HELD = false;
...
private:
	...
	bool KEY_FRONTSLASH_PRESSED = false;
	bool KEY_SEMICOLON_PRESSED = false;
	bool KEY_QUOTE_PRESSED = false;
...
public:
		...
		bool key_A_Pressed() { if (KEY_A_PRESSED) { KEY_A_PRESSED = false; return true; }return false; }
		bool key_B_Pressed() { if (KEY_B_PRESSED) { KEY_B_PRESSED = false; return true; }return false; }
		bool key_C_Pressed() { if (KEY_C_PRESSED) { KEY_C_PRESSED = false; return true; }return false; }
		bool key_D_Pressed() { if (KEY_D_PRESSED) { KEY_D_PRESSED = false; return true; }return false; }
		bool key_E_Pressed() { if (KEY_E_PRESSED) { KEY_E_PRESSED = false; return true; }return false; }
		bool key_F_Pressed() { if (KEY_F_PRESSED) { KEY_F_PRESSED = false; return true; }return false; }
		bool key_G_Pressed() { if (KEY_G_PRESSED) { KEY_G_PRESSED = false; return true; }return false; }
		bool key_H_Pressed() { if (KEY_H_PRESSED) { KEY_H_PRESSED = false; return true; }return false; }
		bool key_I_Pressed() { if (KEY_I_PRESSED) { KEY_I_PRESSED = false; return true; }return false; }
		bool key_J_Pressed() { if (KEY_J_PRESSED) { KEY_J_PRESSED = false; return true; }return false; }
		bool key_K_Pressed() { if (KEY_K_PRESSED) { KEY_K_PRESSED = false; return true; }return false; }
		bool key_L_Pressed() { if (KEY_L_PRESSED) { KEY_L_PRESSED = false; return true; }return false; }
		bool key_M_Pressed() { if (KEY_M_PRESSED) { KEY_M_PRESSED = false; return true; }return false; }
		bool key_N_Pressed() { if (KEY_N_PRESSED) { KEY_N_PRESSED = false; return true; }return false; }
		bool key_O_Pressed() { if (KEY_O_PRESSED) { KEY_O_PRESSED = false; return true; }return false; }
		bool key_P_Pressed() { if (KEY_P_PRESSED) { KEY_P_PRESSED = false; return true; }return false; }
		bool key_Q_Pressed() { if (KEY_Q_PRESSED) { KEY_Q_PRESSED = false; return true; }return false; }
		bool key_R_Pressed() { if (KEY_R_PRESSED) { KEY_R_PRESSED = false; return true; }return false; }
		bool key_S_Pressed() { if (KEY_S_PRESSED) { KEY_S_PRESSED = false; return true; }return false; }
		bool key_T_Pressed() { if (KEY_T_PRESSED) { KEY_T_PRESSED = false; return true; }return false; }
		bool key_U_Pressed() { if (KEY_U_PRESSED) { KEY_U_PRESSED = false; return true; }return false; }
		bool key_V_Pressed() { if (KEY_V_PRESSED) { KEY_V_PRESSED = false; return true; }return false; }
		bool key_W_Pressed() { if (KEY_W_PRESSED) { KEY_W_PRESSED = false; return true; }return false; }
		bool key_X_Pressed() { if (KEY_X_PRESSED) { KEY_X_PRESSED = false; return true; }return false; }
		bool key_Y_Pressed() { if (KEY_Y_PRESSED) { KEY_Y_PRESSED = false; return true; }return false; }
		bool key_Z_Pressed() { if (KEY_Z_PRESSED) { KEY_Z_PRESSED = false; return true; }return false; }
		bool key_COMMA_Pressed()				{ if (KEY_COMMA_PRESSED) { KEY_COMMA_PRESSED = false; return true; }return false; }
		bool key_PERIOD_Pressed()				{ if (KEY_PERIOD_PRESSED) { KEY_PERIOD_PRESSED = false; return true; }return false; }
		bool key_FRONTSLASH_Pressed()				{ if (KEY_FRONTSLASH_PRESSED) { KEY_FRONTSLASH_PRESSED = false; return true; }return false; }
		bool key_SEMICOLON_Pressed()				{ if (KEY_SEMICOLON_PRESSED) { KEY_SEMICOLON_PRESSED = false; return true; }return false; }
		bool key_QUOTE_Pressed()				{ if (KEY_QUOTE_PRESSED) { KEY_QUOTE_PRESSED = false; return true; }return false; }
		bool key_BACKSLASH_Pressed()				{ if (KEY_BACKSLASH_PRESSED) { KEY_BACKSLASH_PRESSED = false; return true; }return false; }
