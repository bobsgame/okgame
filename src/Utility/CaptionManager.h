...
public:
	...
	Caption* newManagedCaption(Caption::Position fixedPosition, int x, int y, int ticks, const string& text, int fontSize = 8, bool outline = false, BobColor* textColor = BobColor::black, BobColor* textBGColor = BobColor::clear, RenderOrder r = RenderOrder::ABOVE_TOP, float scale = 1, Entity* entity = nullptr, Area* area = nullptr);
