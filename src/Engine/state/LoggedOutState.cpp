...
{ //=========================================================================================================================
	...
	GLUtils::drawOutlinedString("You have been logged out by a different session.", (float)GLUtils::getViewportWidth() / 2 - 70, (float)GLUtils::getViewportHeight() / 2 - 12, OKColor::white);
	GLUtils::drawOutlinedString("Press L to take this session back and log out that one.", (float)GLUtils::getViewportWidth() / 2 - 90, (float)GLUtils::getViewportHeight() / 2 + 12, OKColor::gray);
}
