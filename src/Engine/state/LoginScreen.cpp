...
LoginScreen::LoginScreen(Engine *e)
{ //=========================================================================================================================
...
{ //=========================================================================================================================
	...
	GLUtils::drawFilledRect(BobMenu::bgColor->ri(), BobMenu::bgColor->gi(), BobMenu::bgColor->bi(), w / 4 * 1, w / 4 * 3, screenY + h / 4 * 1, screenY + h / 4 * 3, 0.8f);
