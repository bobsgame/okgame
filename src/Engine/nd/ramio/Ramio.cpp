...
{ //=========================================================================================================================
	...
	getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "Alright! It works!", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
...
{ //=========================================================================================================================
	...
	{
		getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "Yeah! I did it!", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
...
{ //=========================================================================================================================
	...
	if (dieSequenceStep == 0)
	{
		...
		if (r == 0)
		{
			getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "Let's try this again.", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
		}
		if (r == 1)
		{
			getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "I was so close!", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
		}
		if (r == 2)
		{
			getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "Grrr. That was stupid.", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
		}
		if (r == 3)
		{
			getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "One more try.", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
		}
		if (r == 4)
		{
			getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 20, 3000, "Nooooooooo!", OKFont::font_normal_8, OKColor::white, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f, -1);
		}
...
{ //=========================================================================================================================
	...
	if (credits == false)
	{
		...
		{
			RAMIO_timercaption = getCaptionManager()->newManagedCaption(Caption::Position::CENTERED_X, 0, 2, -1, timerString, OKFont::font_normal_16_shadow1, OKColor::green, nullptr, OKColor::clear, RenderOrder::ABOVE_TOP, 0.5f);
		}
		else
		{
