...
const string BobNet::Bobs_Game_ActivityStream_Request = "Bobs_Game_ActivityStream_Request:";
...
{//===============================================================================================
	...
	{
		setStunServerIPAddress_S(Main::STUNServerAddressString.c_str(), BobNet::STUNServerUDPPort);//this is server port, so it will always be original port number
