...
public:
	...
	//BOBS GAME
	static const string OK_Game_GameTypesAndSequences_Download_Request;
	static const string OK_Game_GameTypesAndSequences_Download_Response;

	static const string OK_Game_GameTypesAndSequences_Upload_Request;
	static const string OK_Game_GameTypesAndSequences_Upload_Response;

	static const string OK_Game_GameTypesAndSequences_Vote_Request;
	static const string OK_Game_GameTypesAndSequences_Vote_Response;

	static const string OK_Game_RoomList_Request;
	static const string OK_Game_RoomList_Response;
	static const string OK_Game_TellRoomHostToAddMyUserID;
	static const string OK_Game_NewRoomCreatedUpdate;

	static const string OK_Game_HostingPublicRoomUpdate;
	static const string OK_Game_HostingPublicRoomStarted;
	static const string OK_Game_HostingPublicRoomCanceled;
	static const string OK_Game_HostingPublicRoomEnded;

	static const string OK_Game_GameStats;
	static const string OK_Game_GameStats_Response;

	static const string OK_Game_ActivityStream_Request;
	static const string OK_Game_ActivityStream_Response;
	static const string OK_Game_ActivityStream_Update;




	static const string OK_Game_GetHighScoresAndLeaderboardsRequest;
	static const string OK_Game_UserStatsLeaderBoardsAndHighScoresBatched;
	static const string OK_Game_UserStatsForSpecificGameAndDifficulty;
	static const string OK_Game_LeaderBoardsByTotalTimePlayed;
	static const string OK_Game_LeaderBoardsByTotalBlocksCleared;
	static const string OK_Game_LeaderBoardsByPlaneswalkerPoints;
	static const string OK_Game_LeaderBoardsByEloScore;
	static const string OK_Game_HighScoreBoardsByTimeLasted;
	static const string OK_Game_HighScoreBoardsByBlocksCleared;
